...
public class AnimeCommand implements Command {
    ...
    public void action(MessageReceivedEvent event) {
        ...
        String xml = ReadUrl.readUrlWithAuth("https://myanimelist.net/api/anime/search.xml?q=" + anime, Config.malUser, Config.malPassword);
        ...
        if (!xml.equals("")){
            try {
                ...
                embedBuilder.addField("Link", "https://myanimelist.net/anime/" + id, true);
